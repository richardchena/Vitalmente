<template>
    <div>
        <div v-if="isLoading" class="spinner-wrapper">
            ...
            <strong style="font-size: 25px; margin-left: 20px; margin-top:15px; color: black"><p>Registrando profesional... Aguarde por favor</p></strong>
        </div>

        <nav class="navbar" style="background: #c6c6c6">
            <div style="margin-left: 15px">
                <strong>Registrar nuevo profesional</strong>
            </div>
                ...
                <div class="row">
                    <div class="row">
                        ...
                        <div class="col-sm" style="margin-left: 8px">
                            ...
                            <input v-model="reg" type="text" class="form-control" id="ocupacion" placeholder="Ingrese aquí su registro profesional">
                        </div>
                    </div>
                </div>
            </div>
...
export default {
    ...
    methods:{
        ...
        async registrar_profesional(){
            ...
            try {
                const {data} = await authApi.post('/profesionales', objeto)
