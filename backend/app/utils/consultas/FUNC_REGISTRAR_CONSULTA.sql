...
BEGIN
	INSERT INTO CONSULTAS(ID_PACIENTE, ID_PROFESIONAL, ID_ESPECIALIDAD, MOTIVO, ANTECEDENTE, DIAGNOSTICO_ACTUAL, TECNICA_APLICADA)
	VALUES(ID_PAC, ID_PRO, ID_ESP, MOT, ANT, DIA, TEC);
	
    --CONSULTA REGISTRADA!
	RESP.ID := 0;
	RESP.MSG := '¡Consulta registrada correctamente!';
