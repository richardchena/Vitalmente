...
DROP FUNCTION IF EXISTS REGISTRAR_PROFESIONAL (USERS.USERNAME%TYPE,
											USERS.EMAIL%TYPE,
											USERS.PASSWORD%TYPE,
											USERS.TELEFONO%TYPE,
											USERS.ROLE%TYPE,
...
CREATE OR REPLACE FUNCTION REGISTRAR_PROFESIONAL (
	--DATOS DEL USUARIO
...
BEGIN
	...
	WITH ROWS AS (	
		INSERT INTO PERSONAS(PRIMER_NOMBRE, SEGUNDO_NOMBRE, TERCER_NOMBRE, PRIMER_APELLIDO, SEGUNDO_APELLIDO, FECHA_NACIMIENTO, NACIONALIDAD, LUGAR_NACIMIENTO, ESTADO_CIVIL, GENERO, NRO_DOC)
		VALUES(UPPER(NOM1), UPPER(NOM2), UPPER(NOM3), UPPER(APE1), UPPER(APE2), FNAC, NAC, LNAC, EC, G, NDOC) RETURNING ID_PERSONA
	) SELECT ID_PERSONA INTO ID_PERSONA_NEW FROM ROWS;

	INSERT INTO PROFESIONALES(ID_PERSONA, ID_USUARIO, REGISTRO)
	VALUES (ID_PERSONA_NEW, ID_USUARIO, REG);
